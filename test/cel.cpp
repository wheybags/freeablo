// This is all broken in multiple ways, so just commented out for now
...
//                {
//                    out << celPaths[i];
//                    hashPngFolder(blizzconvBase + "/" + bfs::path(path).parent_path().str(), out);
//                    out << std::endl;
//                }
//                else
//                {
...
//{
//    std::string thisFolder = bfs::path(__FILE__).parent_path().str();
//
