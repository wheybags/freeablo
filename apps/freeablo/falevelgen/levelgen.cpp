...
#define ROOMAREA 30
        ...
        FAWorld::World& world, Random::Rng& rng, int32_t width, int32_t height, int32_t dLvl, const DiabloExe::DiabloExe& exe, int32_t previous, int32_t next)
    {
        ...
        Level::Level levelBase(std::move(level), tilPath, minPath, solPath, celPath,
                specialCelPath, specialCelMap, downStairsPoint, upStairsPoint,
                tileset.getDoorMap(), previous, next);
