...
namespace FAGui
{
    CharacterDialoguePopup::CharacterDialoguePopup(GuiManager& guiManager, bool wide)
...
//    }
    ...
    CharacterDialoguePopup::UpdateResult CharacterDialoguePopup::update(struct nk_context* ctx)
    {
        ...
        auto dialogRectangle = nk_rect(screenW / 2.0f - (this->mWide ? boxTex->getWidth() / 2 : 0.0f),
