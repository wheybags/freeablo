...
namespace FAWorld
{
    namespace Missile
    {
        ...
        void MissileCreation::animated16Direction(Missile& missile, Misc::Point dest)
        {
            ...
            int32_t direction16 = static_cast<int32_t>(direction.getDirection16());
            srcPos.setSpeed(3536);
            missile.mGraphics.push_back(boost::make_unique<MissileGraphic>("", missile.getGraphicsPath(direction16), boost::none, srcPos));
        }
            ...
            for (auto angleOffset : {-90, 90})
            {
                ...
                for (int32_t i = 0; i < 6; i++)
                {
                    missile.mGraphics.push_back(
                        boost::make_unique<MissileGraphic>(missile.getGraphicsPath(0), missile.getGraphicsPath(1), boost::none, Position(point)));
        ...
        {
            missile.mGraphics.push_back(boost::make_unique<MissileGraphic>("", missile.getGraphicsPath(0), boost::none, Position(missile.mSrcPoint)));
        }
    }
}
