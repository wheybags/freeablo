...
namespace absl
{
    ...
    public:
        ...
        // Support for absl::Hash.
        template <typename H> friend H AbslHashValue(H h, int128 v) { return H::combine(std::move(h), Int128High64(v), Int128Low64(v)); }
...
#error "Unsupported byte order: must be little-endian or big-endian."
    ...
    inline bool operator==(uint128 lhs, uint128 rhs) { return (Uint128Low64(lhs) == Uint128Low64(rhs) && Uint128High64(lhs) == Uint128High64(rhs)); }
    ...
    inline uint128 operator|(uint128 lhs, uint128 rhs) { return MakeUint128(Uint128High64(lhs) | Uint128High64(rhs), Uint128Low64(lhs) | Uint128Low64(rhs)); }
    ...
    inline uint128 operator<<(uint128 lhs, int amount)
    {
        ...
        if (amount < 64)
        {
            if (amount != 0)
            {
                return MakeUint128((Uint128High64(lhs) << amount) | (Uint128Low64(lhs) >> (64 - amount)), Uint128Low64(lhs) << amount);
            }
            return lhs;
        }
    ...
    inline uint128 operator>>(uint128 lhs, int amount)
    {
        ...
        if (amount < 64)
        {
            if (amount != 0)
            {
                return MakeUint128(Uint128High64(lhs) >> amount, (Uint128Low64(lhs) >> amount) | (Uint128High64(lhs) << (64 - amount)));
            }
            return lhs;
        }
