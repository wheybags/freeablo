...
namespace Render
{
    ...
    std::vector<LevelObject>& get(int32_t x, int32_t y, LevelObjects& objs) { return objs.mData[x + y * objs.mWidth]; }
    ...
    int32_t LevelObjects::width() { return mWidth; }

    int32_t LevelObjects::height() { return mHeight; }
}
